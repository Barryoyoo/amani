...
export default function Footer() {
  ...
  return (
    <footer className="bg-burgundy-900 text-white py-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          {/* Brand Section */}
          <div>
            <h3 className="text-2xl font-serif font-bold text-white mb-4">Amani Temptress Spa</h3>
            <p className="text-gray-300 mb-6 leading-relaxed text-sm">
              Your sanctuary of pure luxury, relaxation, and wellness in the heart of Kilimani, Nairobi.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/about" className="text-gray-300 hover:text-gold-400 transition-colors text-sm">About Us</Link></li>
              <li><Link to="/services" className="text-gray-300 hover:text-gold-400 transition-colors text-sm">Services</Link></li>
              <li><Link to="/gallery" className="text-gray-300 hover:text-gold-400 transition-colors text-sm">Gallery</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-300 hover:text-gold-400 transition-colors text-sm">Privacy Policy</a></li>
              <li><a href="#" className="text-gray-300 hover:text-gold-400 transition-colors text-sm">Terms of Service</a></li>
              <li><a href="#" className="text-gray-300 hover:text-gold-400 transition-colors text-sm">Cancellation Policy</a></li>
              <li><a href="#" className="text-gray-300 hover:text-gold-400 transition-colors text-sm">FAQ</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gold-700 pt-8">
          ...
          <p className="text-gray-400 text-sm text-center">Site developed by <a href="tel:+254710574902" target="_blank" rel="noopener noreferrer" className="text-gold-500 hover:text-gold-400 transition-colors">Barrack Oyoo</a></p>
        </div>
      </div>
    </footer>
  )
